                ...
                if (count($output) > 0) {
                    ...
                    echo "<script>
                            $(document).ready(function () {
                                if($('#aval_sub_menu').empty()){
                                    $('#send').attr('disabled', true);
                                }
                            });
                        </script>";
                    echo '<tr><td><label class="msg_multi_error">All sub-menus are already in use. You must create new sub-menu first.</label></td><td id="aval_sub_menu">&nbsp;</td></tr>';
                }
...
//                }
            ...
            <div id="form-button-area">
                <input type="reset" name="cancel" value="Cancel" class="submit" id="button-last"  /><input type="submit" name="send" value="Save" class="submit" id="send" />
            </div>
